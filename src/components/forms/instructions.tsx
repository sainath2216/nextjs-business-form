      ...
      <CardContent className="space-y-6">
        <div className="space-y-4">
          <p className="text-sm text-gray-600">
            As per the regulations, it is mandatory for all companies and individuals to submit their KYC details. 
            As part of regular KYC collection and updating, we request you kindly submit the below requested KYC details.
          </p>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm text-gray-600">
              ...
              <li>Business Ownership Type (Company/Partnership/LLP/Individual)</li>
